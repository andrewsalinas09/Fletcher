...
Remaining open: multi-node (>2) diff presentation (pairwise vs. all-vs-base vs. overlaid curves); whether learned-from-your-own-ABX-record thresholds ever revisit this (explicitly not now).
